import pandas as pd
from backtest import threshold_timing
from config import FIG_DIR, TAB_DIR, SENTIMENT_METHOD, STRAT_UPPER_Q, STRAT_LOWER_Q, TRADING_COST_BPS
from data_loader import load_news, load_market
from evaluation import corr_and_ic
from feature_engineering import aggregate_daily_sentiment, make_market_features
from plotting import plot_sentiment_vs_market, plot_equity_curves
from sentiment_lexicon import score_text as score_lex
from sentiment_transformer import score_text_transformer as score_trf
